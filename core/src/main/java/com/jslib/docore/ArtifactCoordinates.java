...
public class ArtifactCoordinates implements Converter {
	...
	public static ArtifactCoordinates parse(String value) {
		...
		return new ArtifactCoordinates(value.substring(0, firstSeparator), value.substring(firstSeparator + 1, secondSeparator), value.substring(secondSeparator + 1));
	}
